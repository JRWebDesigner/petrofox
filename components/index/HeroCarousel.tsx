    ...
    >
      {carouselItems.map((item, index) => (
        <SwiperSlide key={index} className='relative h-full'>
            ...
            />
            <div className="relative bg-black/30 h-full flex items-end md:items-center justify-start z-20">
              <div className="text-white max-w-4xl px-8 text-shadow-lg">
                <h1 className="text-3xl md:text-5xl font-black text-white text-shadow-[6px_30px_black]">Transporte y Logística <br/> de Carga en Bolivia</h1>
